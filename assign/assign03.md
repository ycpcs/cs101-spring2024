...
* Milestone 1:
    * Code due: **Monday, Mar 11th** by 11:59 PM
* Milestone 2:
    * Design due: **Thursday, Mar 14th** in class
    * Code due: **Wednesday, Mar 20th** by 11:59 PM

Getting Started
===============

Start by downloading [CS101\_Assign03\_Sp24.zip](CS101_Assign03_Sp24.zip), saving it in the directory **H:\\CS101**. In Windows File Explorer, navigate to **H:\\CS101**, right click on **CS101\\_Assign03\\_Sp24.zip**, and select **Extract All** to create a **CS101\\_Assign03\\_Sp24** directory with the assignment files.

Start a **Cygwin Bash Shell** and run the following commands:

    cd h:
    cd CS101
    cd CS101_Assign03_Sp24

Using **Notepad++**, open the file

> **H:\\CS101\\CS101\_Assign03\_Sp24\\Dominoes.cpp**
...
The code for Milestone 1 should be submitted to Marmoset (using the command `make submit_ms1`) by the end of the day on **Monday, Mar 11th**.
...
The [design artifact](../design-template.pdf) for Milestone 2 is due at the beginning class on **Thursday, Mar 14th**.  Make sure that you fill out the "Strategy" and "Control flow sketch" sections of the design template.

The code for Milestone 2 should be submitted to Marmoset (using the command `make submit_ms2`) by the end of the day on **Wednesday, Mar 20th**.
